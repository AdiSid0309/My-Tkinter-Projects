...
Tops.pack(side=TOP)
f1=Frame(root,width=620,height=600,bd=10,background='blue',relief="raise")
f1.pack(side=BOTTOM)
...
f1a=Frame(f1,width=620,height=600,bd=0,background='white',relief="flat")
f1a.pack(side=TOP)
topLeft2=Frame(f1a,width=620,height=600,bd=8,background='white',relief="raise")
topLeft2.pack(side=TOP)


Tops.configure(background="light blue")
lblTitle=Label(Tops,font=('arial',25,'bold'),text="Customer Support Chat BOT",bd=12,background='light blue',width=28,justify='center')
...
entOneWay=Entry(frameBottom,font=('arial',20,'bold'),textvariable=var1,bd=2,width=25)
...
text_box = Text(topLeft2,width = 70, height = 100)
...
def x(event = None):
    ...
    while guess=='new order' :
        cboDestination = ttk.Combobox(frameBottom, textvariable=var2, state='readonly', font=('arial', 9, 'bold'), width=7)
        ...
        btnOk = Button(frameBottom, text='Ok', padx=2, pady=2, bd=3, fg="black", background='light blue',
                        font=('Arial Rounded MT', 6, 'bold'), width=3, height=1, command=product).pack(side=LEFT)
        cboDestination = ttk.Combobox(frameBottom, textvariable=var3, state='readonly', font=('arial', 9, 'bold'), width=7)
        ...
        btnQuan = Button(frameBottom, text='Add', padx=2, pady=2, bd=3, fg="black", background='light blue',
                        font=('Arial Rounded MT', 6, 'bold'), width=3, height=1, command=quantity).pack(side=RIGHT)
        break
